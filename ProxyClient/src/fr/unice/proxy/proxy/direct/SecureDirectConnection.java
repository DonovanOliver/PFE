...
public class SecureDirectConnection {
	...
	public void initialize(String address, int port) throws NoSuchAlgorithmException, ClientProtocolException, IOException, InvalidKeySpecException, InvalidKeyException, NoSuchPaddingException, IllegalBlockSizeException, BadPaddingException, NoSuchProviderException {
		...
		Log.i("AES", "Generating DH KeyPAir");
		...
		Log.i("AES", "DH Keypair generated. Got the public key");
		...
		Log.i("AES", "Sending the public key to the other side...");
		...
		Log.i("AES", "Sent the public key and got the result back");
		...
		Log.i("AES", "Regenerated the public key. Doing the key agreement...");
		...
		Log.i("All Keys", "Sending all keys....");
		...
		Log.i("All Keys", "Received other public keys. Reconstructing...");
		...
		Log.i("All Keys", "Got the bytes. Reconstructing...");
		...
		Log.i("My AES Hash", new String(sha1ize(getMySecretKeyAES()
				.getEncoded()), "UTF-8"));
		Log.i("My DES Hash", new String(sha1ize(getMySecretKeyDES()
				.getEncoded()), "UTF-8"));
		Log.i("My Pub RSA Hash", new String(sha1ize(getMyPublicKeyRSA()
				.getEncoded()), "UTF-8"));
		Log.i("My Pub DSA Hash", new String(sha1ize(getMyPublicKeyDSA()
				.getEncoded()), "UTF-8"));
		Log.i("Other Pub RSA Hash", new String(
				sha1ize(getStrangerPublicKeyRSA().getEncoded()), "UTF-8"));
		Log.i("Other Pub DSA Hash", new String(
	...
	public byte[] finalizeKeyAgreement(byte[] pkBytesSerialized) {
		...
		try {
			...
			Log.i("AES", "Reconstructed public key");
			...
			Log.i("AES", "Generated my own keypair");
			...
			Log.i("AES", "Got the secret key too");
	...
	public byte[] finalizeKeyExchange(byte[] pkBytesSerialized) {
		...
		try {
			...
			Log.i("All Keys", "Decrypted content and got the object inside");
			...
			Log.i("All Keys", "Got the AES Key and reconstructed it");
			...
			Log.i("All Keys", "Got the DES Key and reconstructed it");
			...
			Log.i("All Keys", "Got the RSA Key and reconstructed it");
			...
			Log.i("All Keys", "Got the DSA Key and reconstructed it");

			Log.i("All Keys", "Generating my own RSA...");
			...
			Log.i("All Keys", "Generating my own DSA...");
			...
			Log.i("All Keys", "Putting the keys in the object...");
