...
public class RequestManager {
	...
	public void parse(SecurityPreferences sp) {
		...
		Log.d("myapps"," RequestManger level = "+sp.getUserLevel());
	...
	public String getSecured(byte[] clear, SecurityPreferences sp) {
		...
		if (sp.isConfidentiality()) {
			Log.i("myapps","Confidentiality" + "Starting Confidentiality");
			...
			if (sp.getConfidentialityAlgorithm().contains("RSA")) {
				...
				Log.i("myapps","Confidentiality" + "Failed Confidentiality");
				return null;
			}
			...
			Log.i("myapps","Confidentiality" + "Finished Confidentiality");
		}
		else {
		...
		if (sp.isAuthenticity()) {
			Log.i("myapps","Authenticity" + "Starting Authenticity");
			...
			try {
				...
				Log.i("myapps","Authenticity" + "Failed Authenticity");
				e.printStackTrace();
				return null;
			}
			sdata.setSignature(signature);
			Log.i("myapps","Authenticity" + "Finished Authenticity");
		}
		
		if (sp.isNonrepudiation()) {
			Log.i("myapps","NonRepudiation" + "Starting NonRepudiation");
			...
			try {
				...
				Log.i("myapps","NonRepudiation" + "Failed NonRepudiation");
				e.printStackTrace();
				return null;
			}
			Log.i("myapps","NonRepudiation" + "Finished NonRepudiation");
		}
